    ...
    if known_profile:
        ...
        if name in {"mujoco", "mjwarp"}:
            ...
            declare(
                ...
                "body_mass/base_mass_delta and body_ipos/base_com_offset by "
                "prevalidating public columns and applying public Link mass "
                "and COM overrides through owning variant data slices. "
            ...
            declare(
                ...
                "base_mass_delta, body_ipos, base_com_offset and actuator kp/kd "
